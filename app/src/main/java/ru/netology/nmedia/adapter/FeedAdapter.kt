...
import ru.netology.nmedia.dto.PostTime
...
class FeedAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            typeTime -> PostTimeViewHolder(
                CardTimeBinding.inflate(layoutInflater, parent, false),
                onInteractionListener
            )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        getItem(position)?.let {
            when (it) {
                ...
                is PostTime -> (holder as? PostTimeViewHolder)?.bind(it)
            }
        }
    }
    ...
    class PostTimeViewHolder(
        private val binding: CardTimeBinding,
        private val onInteractionListener: OnInteractionListener,
    ) : RecyclerView.ViewHolder(binding.root) {

        fun bind(timePost: PostTime) {
            binding.apply {
                time.text = timePost.timeString
            }
        }
    }
